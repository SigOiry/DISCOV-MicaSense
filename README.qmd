...
$$\huge\color{orange}{\colorbox{white}{\textsf{\textbf{3 - Magnoliopsida}}}}$$
...
$$\huge\color{lightgreen}{\colorbox{white}{\textsf{\textbf{3 - Magnoliopsida}}}}$$
...
$$\huge\color{green}{\colorbox{white}{\textsf{\textbf{3 - Magnoliopsida}}}}$$ Marine angiosperm of the genus *Nanozostera sp.* (syn. *Zostera sp.*). The model has been trained exclusively on pixels from *Nanozostera noltei* (syn. *Zostera noltei*). 

$\huge\color{brown}{\textsf{\textbf{4 - Phaeophyceae}}}$

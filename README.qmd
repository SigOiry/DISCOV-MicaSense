...
Alternativelty to Rstudio, you can used software like [VS code](https://code.visualstudio.com) that will allow you to edit and play with code written in R and python in the same working environment.

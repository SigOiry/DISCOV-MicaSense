...
To run this script, navigate to your Downloads folder in Finder. While holding the 'control' key, right-click on the 'Downloads' folder in the path bar at the bottom of the window. Select 'Open in Terminal'. Then, `run sh Miniforge3-MacOSX-x86_64.sh` and follow the instructions. Once it's complete, execute `conda init` and close the Terminal.

...
The  **D**rone **I**ntertidal **S**ubstrats **C**lassification **O**f **V**egetation (DISCOV) is a Neural Network classification model trained on a Micasense RedEdge-MX Dual multispectral drone camera.
:::
